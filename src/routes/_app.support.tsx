      ...
      <Card className="glass border-0 p-6" id="faq">
        ...
        <Accordion type="single" collapsible className="mt-4">
          {[
            {
              q: "Where's my bundle?",
              a: "Most orders are delivered in seconds. Check the Orders page — if it stays Pending for more than 5 minutes, contact us.",
            },
            {
              q: "Can I get a refund?",
              a: "Yes — failed orders are refunded automatically, and you can request a refund on Completed orders within 24 hours if the bundle didn't reach the recipient.",
            },
            {
              q: "Which networks do you support?",
              a: "MTN Ghana today. Vodafone and AirtelTigo are coming soon.",
            },
          ].map((f, i) => (
